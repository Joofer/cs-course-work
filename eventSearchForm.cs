...
namespace u17
{
    public partial class eventSearchForm : Form
    {
        ...
        private void SaveData()
        {
            ...
            string query = @"UPDATE [" + ConfigurationManager.AppSettings["conference"] + @"] SET name = '" + name + @"', date = '" + date + @"', time = '" + time + @"' WHERE id = '" + id.ToString() + @"';";
        ...
        private void DeleteData()
        {
            ...
            string query = @"DELETE [" + ConfigurationManager.AppSettings["conference"] + @"] WHERE id = '" + id + @"';";
